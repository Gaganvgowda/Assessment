...
public class EmployeeService {
    ...
    public Integer updateEmp(String id,String firstName,String lastName,String email) {
        return template.update("update employee.employee_profiles set first_name=:first, last_name=:last, email=:email where id=:id",
    ...
    public Map<String,Object> getEmpByid(String id) {
        try {
            return template.queryForMap("SELECT * FROM employee.employee_profiles where id=:id",
                    new MapSqlParameterSource().addValue("id",id));
        } catch (DataAccessException e) {
            return null;
        }
